      ...
      >
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          ...
          <ul className="hidden lg:flex col-start-4 col-end-8 text-black-500  items-center">
            ...
            <li onClick={() => handleNavigation("chat")} className={"px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative" + (activeLink === "chat" ? " text- blue-500 animation-active " : " text-black-500  ")}>Chat</li>
            <li onClick={() => handleNavigation("profile")} className={"px-4 py-2 mx-2 cursor-pointer animation-hover inline-block relative" + (activeLink === "profile" ? " text- blue-500 animation-active " : " text-black-500  ")}>Profile</li>
          </ul>
        </nav>
      </header>
